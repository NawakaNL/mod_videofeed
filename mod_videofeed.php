...
$list            = ModVideoFeedHelper::getList($params);
...
// Add Lity
$document->addStyleSheet(JUri::base().'modules/mod_videofeed/vendor/lity.min.css');
$document->addScript(JUri::base().'modules/mod_videofeed/vendor/lity.min.js');
